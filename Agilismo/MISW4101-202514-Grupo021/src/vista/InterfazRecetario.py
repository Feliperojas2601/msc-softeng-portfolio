...
class App_Recetario(QApplication):
    ...
    def crear_ingrediente(self, nombre, unidad, valor, sitioCompra):
        ...
        """
        validacion = self.logica.validar_crear_editar_ingrediente(nombre, unidad, valor, sitioCompra, True)
        if validacion == "":
    ...
    def editar_ingrediente(self, id, nombre, unidad, valor, sitioCompra):
        ...
        """
        validacion = self.logica.validar_crear_editar_ingrediente(nombre, unidad, valor, sitioCompra, False)
        if validacion == "":
