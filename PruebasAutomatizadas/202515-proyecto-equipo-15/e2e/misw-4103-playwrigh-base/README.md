# Proyecto Base: Pruebas End to End con Playwright para la versión base
...
Este repositorio cuenta con la configuración base de Playwright para la automatización de pruebas E2E y su uso en una actividad de VRT para una versión de docker diferente.
