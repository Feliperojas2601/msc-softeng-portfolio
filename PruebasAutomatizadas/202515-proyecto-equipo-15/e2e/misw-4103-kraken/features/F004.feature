...
@user2 @web
Scenario: E012: Asignar etiqueta a página.
    Given I navigate to page "<BASEURL>"
    And I wait for 2 seconds
    And I run this project
    And I wait for 2 seconds
    ...
    And I wait for 3 seconds
    And I click within the pages list
    And I click on the created page
    And I click on the page settings
    And I wait for 3 seconds
    And I assign the created tag to the page
    And I wait for 3 seconds
    Then I should see the assigned tag in the page
