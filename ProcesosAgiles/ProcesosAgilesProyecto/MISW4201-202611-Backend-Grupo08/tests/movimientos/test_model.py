...
from modelos import Usuario, Propiedad, Movimiento, Banco, TipoMovimiento, db


class TestModeloMovimiento(TestCase):

    def setUp(self):
        usuario = Usuario(usuario='usuario_2', rol=Usuario.ROL_PROPIETARIO, contrasena='123456')
